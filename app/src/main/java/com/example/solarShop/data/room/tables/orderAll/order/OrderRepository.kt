...
interface OrderRepository {
    ...
    /*
     * برای سازگاری نام قبلی حفظ شده؛
     * از این به بعد soft delete است.
     */
    ...
    fun getOrderWithPriceEstimates(
        orderId: Int
    ): Flow<OrderWithPriceEstimate?>

    fun getOrderWithSelectedChoice(
        orderId: Int
    ): Flow<OrderWithSelectedChoice?>

    fun observeOrderWithTimelineItem(
        orderId: Int
    ...
    suspend fun deleteOrderWithChildren(
        orderId: Int
    )
